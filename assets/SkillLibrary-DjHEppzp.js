...
})`,tags:["Discord","Bot","Claude API"]}];u.forEach(t=>{t.count=m.filter(n=>n.category===t.id).length});const R={かんたん:"bg-emerald-500/20 text-emerald-400 border-emerald-500/30",ふつう:"bg-yellow-500/20 text-yellow-400 border-yellow-500/30",むずかしい:"bg-red-500/20 text-red-400 border-red-500/30"},k={かんたん:"●○○",ふつう:"●●○",むずかしい:"●●●"};function D({skill:t,onClick:n}){const[r,p]=d.useState(!1),s=u.find(i=>i.id===t.category),c=i=>{i.stopPropagation(),navigator.clipboard.writeText(t.prompt).then(()=>{p(!0),setTimeout(()=>p(!1),1800)})};return e.jsxs("div",{onClick:n,className:"group flex flex-col rounded-2xl border border-gray-800 bg-gray-900 hover:border-gray-600 hover:bg-gray-800/80 transition-all cursor-pointer overflow-hidden",children:[e.jsxs("div",{className:"flex items-start gap-3 p-4",style:{borderBottom:`2px solid ${s==null?void 0:s.color}22`},children:[e.jsx("div",{className:"shrink-0 w-10 h-10 rounded-xl flex items-center justify-center text-xl shadow",style:{background:`${s==null?void 0:s.color}22`},children:t.emoji}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-2 flex-wrap",children:[e.jsx("h3",{className:"text-white font-bold text-sm leading-tight group-hover:text-brand-300 transition-colors",children:t.name}),e.jsx("span",{className:`shrink-0 text-xs px-1.5 py-0.5 rounded font-mono ${t.type==="slash"?"bg-brand-500/20 text-brand-400":"bg-purple-500/20 text-purple-400"}`,children:t.type==="slash"?"/コマンド":"プロンプト"})]}),e.jsx("p",{className:"text-gray-400 text-xs mt-1 leading-relaxed line-clamp-2",children:t.description})]})]}),e.jsxs("div",{className:"mx-4 mt-3 rounded-xl overflow-hidden border border-gray-700 flex-1",children:[e.jsxs("div",{className:"flex items-center gap-1.5 px-3 py-2 bg-gray-800 border-b border-gray-700",children:[e.jsx("div",{className:"w-2.5 h-2.5 rounded-full bg-red-400"}),e.jsx("div",{className:"w-2.5 h-2.5 rounded-full bg-yellow-400"}),e.jsx("div",{className:"w-2.5 h-2.5 rounded-full bg-green-400"}),e.jsx(f,{size:10,className:"text-gray-500 ml-1"}),e.jsx("span",{className:"text-gray-500 text-xs ml-0.5",children:"Claude Code"})]}),e.jsxs("div",{className:"bg-gray-950 px-3 py-2.5",children:[e.jsxs("div",{className:"flex items-start gap-2",children:[e.jsx("span",{className:"text-emerald-400 font-mono text-xs shrink-0 mt-0.5",children:"❯"}),e.jsx("code",{className:"text-brand-300 font-mono text-xs leading-relaxed break-all",children:t.prompt.length>80?t.prompt.slice(0,80)+"…":t.prompt})]}),e.jsx("div",{className:"mt-2 pl-4 border-l-2 border-gray-700",children:e.jsx("p",{className:"text-gray-400 font-mono text-xs leading-relaxed line-clamp-2 whitespace-pre-line",children:t.output.split(`
`).slice(0,2).join(`
`)})})]})]}),e.jsxs("div",{className:"flex items-center justify-between px-4 py-3 mt-2",children:[e.jsx("div",{className:"flex items-center gap-2",children:e.jsxs("span",{className:`text-xs px-2 py-0.5 rounded-full border font-medium ${R[t.difficulty]}`,children:[k[t.difficulty]," ",t.difficulty]})}),e.jsxs("button",{onClick:c,className:`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${r?"bg-emerald-500/20 text-emerald-400":"bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white"}`,children:[r?e.jsx(v,{size:12}):e.jsx(w,{size:12}),r?"コピー済み！":"コピー"]})]})]})}const U={かんたん:"bg-emerald-500/20 text-emerald-400 border-emerald-500/30",ふつう:"bg-yellow-500/20 text-yellow-400 border-yellow-500/30",むずかしい:"bg-red-500/20 text-red-400 border-red-500/30"};function M({skill:t,onClose:n}){const[r,p]=d.useState(!1),s=u.find(i=>i.id===t.category),c=()=>{navigator.clipboard.writeText(t.prompt).then(()=>{p(!0),setTimeout(()=>p(!1),2e3)})};return e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm",onClick:n,children:e.jsxs("div",{className:"relative w-full max-w-lg rounded-2xl bg-gray-900 border border-gray-700 shadow-2xl overflow-hidden",onClick:i=>i.stopPropagation(),children:[e.jsxs("div",{className:"flex items-center gap-4 px-6 py-5",style:{background:`linear-gradient(135deg, ${s==null?void 0:s.color}22, transparent)`},children:[e.jsx("div",{className:"w-14 h-14 rounded-2xl flex items-center justify-center text-3xl shadow-lg shrink-0",style:{background:`${s==null?void 0:s.color}33`},children:t.emoji}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-2 flex-wrap",children:[e.jsx("h2",{className:"text-white font-bold text-lg",children:t.name}),e.jsx("span",{className:`text-xs px-2 py-0.5 rounded-full border font-medium ${U[t.difficulty]}`,children:t.difficulty})]}),e.jsxs("div",{className:"flex items-center gap-2 mt-1",children:[e.jsxs("span",{className:"text-xs text-gray-400",children:[s==null?void 0:s.emoji," ",s==null?void 0:s.label]}),e.jsx("span",{className:`text-xs px-1.5 py-0.5 rounded font-mono ${t.type==="slash"?"bg-brand-500/20 text-brand-400":"bg-purple-500/20 text-purple-400"}`,children:t.type==="slash"?"/コマンド":"プロンプト"})]})]}),e.jsx("button",{onClick:n,className:"w-8 h-8 rounded-full bg-gray-800 hover:bg-gray-700 flex items-center justify-center text-gray-400 hover:text-white transition-colors shrink-0",children:e.jsx(g,{size:16})})]}),e.jsxs("div",{className:"px-6 py-4 space-y-4 max-h-[70vh] overflow-y-auto",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-gray-500 font-medium mb-1.5",children:"📖 どんなスキル？"}),e.jsx("p",{className:"text-gray-200 text-sm leading-relaxed",children:t.description})]}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-gray-500 font-medium mb-2",children:"⌨️ Claude Codeに入力する文字"}),e.jsxs("div",{className:"rounded-xl overflow-hidden border border-gray-700",children:[e.jsxs("div",{className:"flex items-center gap-1.5 px-3 py-2 bg-gray-800 border-b border-gray-700",children:[e.jsx("div",{className:"w-2.5 h-2.5 rounded-full bg-red-400"}),e.jsx("div",{className:"w-2.5 h-2.5 rounded-full bg-yellow-400"}),e.jsx("div",{className:"w-2.5 h-2.5 rounded-full bg-green-400"}),e.jsx(f,{size:10,className:"text-gray-500 ml-1"}),e.jsx("span",{className:"text-gray-500 text-xs ml-0.5",children:"Claude Code — ターミナル"})]}),e.jsxs("div",{className:"bg-gray-950 px-4 py-3",children:[e.jsxs("div",{className:"flex items-start gap-2",children:[e.jsx("span",{className:"text-emerald-400 font-mono text-sm shrink-0",children:"❯"}),e.jsx("code",{className:"text-brand-300 font-mono text-sm leading-relaxed whitespace-pre-wrap break-all",children:t.prompt})]}),e.jsxs("div",{className:"mt-1 ml-4 flex items-center gap-1.5",children:[e.jsx("div",{className:"w-2 h-4 bg-brand-400 animate-pulse rounded-sm"}),e.jsx("span",{className:"text-gray-600 text-xs",children:"ここにカーソルがある"})]})]})]}),e.jsxs("button",{onClick:c,className:`mt-2 w-full flex items-center justify-center gap-2 py-2.5 rounded-xl font-medium text-sm transition-all ${r?"bg-emerald-500/20 text-emerald-400 border border-emerald-500/30":"bg-brand-500 hover:bg-brand-600 text-white"}`,children:[r?e.jsx(v,{size:16}):e.jsx(w,{size:16}),r?"クリップボードにコピーしました！":"この文字をコピーする"]})]}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-gray-500 font-medium mb-2",children:"💬 Claudeの返答例"}),e.jsx("div",{className:"rounded-xl bg-gray-800/60 border border-gray-700 px-4 py-3",children:e.jsx("p",{className:"text-gray-300 text-sm leading-relaxed font-mono whitespace-pre-line",children:t.output})})]}),t.tags.length>0&&e.jsxs("div",{children:[e.jsxs("p",{className:"text-xs text-gray-500 font-medium mb-2 flex items-center gap-1",children:[e.jsx(L,{size:12})," タグ"]}),e.jsx("div",{className:"flex flex-wrap gap-1.5",children:t.tags.map(i=>e.jsxs("span",{className:"text-xs px-2.5 py-1 rounded-full bg-gray-800 text-gray-400 border border-gray-700",children:["#",i]},i))})]}),e.jsxs("div",{className:"rounded-xl bg-brand-500/10 border border-brand-500/20 px-4 py-3",children:[e.jsx("p",{className:"text-brand-400 text-xs font-bold mb-1",children:"💡 使い方のコツ"}),e.jsx("p",{className:"text-gray-300 text-xs leading-relaxed",children:t.type==="slash"?"ターミナルに「"+t.prompt+"」と入力してEnterキーを押すだけ！ 簡単だよ。":"上の文章をコピーして、Claude Codeのターミナル画面に貼り付けてEnterを押そう。"})]})]})]})})}function W(){var C,N;const[t,n]=d.useState(""),[r,p]=d.useState("all"),[s,c]=d.useState("all"),[i,x]=d.useState("all"),[b,h]=d.useState(null),y=d.useMemo(()=>{let o=m;if(r!=="all"&&(o=o.filter(a=>a.category===r)),s!=="all"&&(o=o.filter(a=>a.difficulty===s)),i!=="all"&&(o=o.filter(a=>a.type===i)),t.trim()){const a=t.toLowerCase();o=o.filter(l=>l.name.toLowerCase().includes(a)||l.description.toLowerCase().includes(a)||l.prompt.toLowerCase().includes(a)||l.tags.some(A=>A.includes(a)))}return o},[t,r,s,i]),j=()=>{n(""),p("all"),c("all"),x("all")},E=t||r!=="all"||s!=="all"||i!=="all";return e.jsxs("div",{className:"max-w-7xl mx-auto px-4 py-8 space-y-8",children:[e.jsxs("div",{className:"text-center space-y-3",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-brand-500/10 border border-brand-500/30 rounded-full px-4 py-1.5 text-brand-400 text-sm font-medium",children:[e.jsx(T,{size:14}),"SKILLライブラリ"]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-bold text-white",children:["使えるSKILL ",e.jsxs("span",{className:"text-brand-400",children:[m.length,"個"]})," 全部見せます！"]}),e.jsxs("p",{className:"text-gray-400 max-w-xl mx-auto text-sm leading-relaxed",children:["カテゴリから選ぶか、検索して使いたいSKILLを見つけよう。",e.jsx("br",{}),"コピーボタンを押してClaudeに貼り付けるだけ！"]}),e.jsxs("div",{className:"inline-flex items-center gap-3 bg-gray-800/60 border border-gray-700 rounded-xl px-5 py-3 text-left mt-2",children:[e.jsx(f,{size:20,className:"text-brand-400 shrink-0"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-white text-sm font-bold",children:"SKILLってどこに入力するの？"}),e.jsx("p",{className:"text-gray-400 text-xs mt-0.5",children:"ターミナル（黒い画面）でClaudeが起動している場所に入力するよ。カードをタップすると詳しく説明するね！"})]})]})]}),e.jsxs("div",{className:"relative max-w-xl mx-auto",children:[e.jsx(I,{size:16,className:"absolute left-4 top-1/2 -translate-y-1/2 text-gray-500"}),e.jsx("input",{value:t,onChange:o=>n(o.target.value),placeholder:"名前・説明・タグで検索… 例：「コード」「エラー」「SNS」",className:"w-full bg-gray-800 border border-gray-700 rounded-2xl pl-10 pr-10 py-3.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-brand-500 transition-colors"}),t&&e.jsx("button",{onClick:()=>n(""),className:"absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-300",children:e.jsx(g,{size:16})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx("p",{className:"text-xs text-gray-500 font-medium",children:"📂 カテゴリで絞り込む"}),e.jsxs("div",{className:"flex flex-wrap gap-2",children:[e.jsxs("button",{onClick:()=>p("all"),className:`flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-sm font-medium border transition-all ${r==="all"?"bg-brand-500/20 border-brand-500/50 text-brand-300":"bg-gray-800 border-gray-700 text-gray-400 hover:border-gray-600 hover:text-white"}`,children:["🗂️ すべて（",m.length,"）"]}),u.map(o=>{const a=m.filter(l=>l.category===o.id).length;return e.jsxs("button",{onClick:()=>p(o.id),className:`flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-sm font-medium border transition-all ${r===o.id?"text-white border-transparent":"bg-gray-800 border-gray-700 text-gray-400 hover:border-gray-600 hover:text-white"}`,style:r===o.id?{background:`${o.color}33`,borderColor:o.color}:{},children:[o.emoji," ",o.label,e.jsxs("span",{className:"text-xs opacity-60",children:["(",a,")"]})]},o.id)})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-4",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-xs text-gray-500",children:"難易度："}),["all","かんたん","ふつう","むずかしい"].map(o=>e.jsx("button",{onClick:()=>c(o),className:`text-xs px-2.5 py-1 rounded-lg border transition-colors ${s===o?"bg-brand-500/20 border-brand-500/50 text-brand-300":"bg-gray-800 border-gray-700 text-gray-400 hover:text-white"}`,children:o==="all"?"すべて":o},o))]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-xs text-gray-500",children:"種類："}),[{v:"all",label:"すべて"},{v:"slash",label:"/コマンド"},{v:"prompt",label:"プロンプト"}].map(({v:o,label:a})=>e.jsx("button",{onClick:()=>x(o),className:`text-xs px-2.5 py-1 rounded-lg border transition-colors ${i===o?"bg-brand-500/20 border-brand-500/50 text-brand-300":"bg-gray-800 border-gray-700 text-gray-400 hover:text-white"}`,children:a},o))]}),E&&e.jsxs("button",{onClick:j,className:"text-xs text-gray-500 hover:text-gray-300 flex items-center gap-1 transition-colors",children:[e.jsx(g,{size:12})," フィルターをリセット"]})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("p",{className:"text-sm text-gray-400",children:[e.jsx("span",{className:"text-white font-bold",children:y.length})," / ",m.length," スキルを表示中"]}),r!=="all"&&e.jsxs("div",{className:"flex items-center gap-2 text-sm",children:[e.jsx("span",{className:"text-gray-400",children:"カテゴリ："}),e.jsxs("span",{className:"text-white font-medium",children:[(C=u.find(o=>o.id===r))==null?void 0:C.emoji," ",(N=u.find(o=>o.id===r))==null?void 0:N.label]})]})]}),y.length===0?e.jsxs("div",{className:"text-center py-20 space-y-4",children:[e.jsx("p",{className:"text-5xl",children:"🤔"}),e.jsx("p",{className:"text-gray-400 font-medium",children:"スキルが見つかりませんでした"}),e.jsx("p",{className:"text-gray-600 text-sm",children:"別のキーワードやカテゴリで試してみてね"}),e.jsx("button",{onClick:j,className:"text-brand-400 hover:text-brand-300 text-sm transition-colors",children:"→ フィルターをリセットする"})]}):e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4",children:y.map(o=>e.jsx(D,{skill:o,onClick:()=>h(o)},o.id))}),e.jsxs("div",{className:"rounded-2xl bg-gray-800/40 border border-gray-700 p-6 text-center space-y-3",children:[e.jsx(P,{size:28,className:"text-brand-400 mx-auto"}),e.jsx("h3",{className:"text-white font-bold text-lg",children:"SKILLのつかいかたがわからない？"}),e.jsxs("p",{className:"text-gray-400 text-sm max-w-md mx-auto leading-relaxed",children:["初心者ガイドでClaude Codeの起動方法から丁寧に説明しているよ。",e.jsx("br",{}),"スキルカードをタップすると詳しい入力方法も見られるよ！"]}),e.jsx("a",{href:"/guide",className:"inline-flex items-center gap-2 bg-brand-500 hover:bg-brand-600 text-white px-5 py-2.5 rounded-xl font-medium text-sm transition-colors",children:"🔰 初心者ガイドを見る"})]}),b&&e.jsx(M,{skill:b,onClose:()=>h(null)})]})}export{W as SkillLibrary};
